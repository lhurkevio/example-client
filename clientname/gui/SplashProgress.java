...
public class SplashProgress {
    ...
    public static void setProgress(int givenPorgress, String givenText){
        PROGRESS = givenPorgress;
        CURRENT = givenText;
        update();
    }
    public static void drawSplash(TextureManager tn){
        ...
        GlStateManager.loadIdentity();
        GlStateManager.translate(0.0D, 000D, -2000.0D);
